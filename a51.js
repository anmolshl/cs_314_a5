...
renderer.setClearColor (0x000000, 1); // set background colour
...
var material = new THREE.MeshStandardMaterial({ color: "#ffa500", transparent: false, side: THREE.DoubleSide, alphaTest: 0.17 });
var alphaMap = new THREE.TextureLoader().load('images/sun.png');
material.alphaMap = alphaMap;
material.alphaMap.magFilter = THREE.NearestFilter;
material.alphaMap.wrapT = THREE.RepeatWrapping;
material.alphaMap.repeat.y = 1;

var material1 = new THREE.MeshStandardMaterial({color: "#0xffffff", transparent: false, side:THREE.DoubleSide , alphaTest: 0.9});
var alphaMap1 = new THREE.TextureLoader().load('images/starsy.jpg');
material1.alphaMap = alphaMap1;
...
wallGeometry1 = new THREE.PlaneBufferGeometry(2*size, 2*size);
wallGeometry2 = new THREE.PlaneBufferGeometry(2*size, 2*size);
wallGeometry3 = new THREE.PlaneBufferGeometry(2*size, 2*size);
wallGeometry4 = new THREE.PlaneBufferGeometry(2*size, 2*size);
wallGeometry5 = new THREE.PlaneBufferGeometry(2*size, 2*size);
...
posxWall = new THREE.Mesh(wallGeometry, material1);   // define the wall object:  geom + shader
...
negxWall = new THREE.Mesh(wallGeometry1, material1);   // define the wall object:  geom + shader
...
posyWall = new THREE.Mesh(wallGeometry2, material1);   // define the wall object:  geom + shader
...
negyWall = new THREE.Mesh(wallGeometry3, material1);   // define the wall object:  geom + shader
...
poszWall = new THREE.Mesh(wallGeometry4, material1);   // define the wall object:  geom + shader
...
negzWall = new THREE.Mesh(wallGeometry5, material1);   // define the wall object:  geom + shader
...
sphereGeometry = new THREE.SphereGeometry(0.7, 32, 32);    // radius, segments, segments
lightSphere = new THREE.Mesh(sphereGeometry, material);
...
function update() {
  ...
  lightSphere.material.alphaMap.offset.y = clock.getElapsedTime()*0.2;
  lightSphere.material.alphaMap.offset.z = clock.getElapsedTime()/0.3;
  poszWall.material.alphaMap.offset.y = clock.getElapsedTime()*0.2;
  if(orbitBool == true){
    orbitRight(light);
  }
