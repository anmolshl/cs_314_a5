...
var material1 = new THREE.MeshStandardMaterial({ color: "#ffa500", transparent: false, side: THREE.DoubleSide, alphaTest: 0.17 });
var alphaMap1 = new THREE.TextureLoader().load('images/stars.jpg');
...
negxWall = new THREE.Mesh(wallGeometry1, negxMaterial);   // define the wall object:  geom + shader
...
posyWall = new THREE.Mesh(wallGeometry2, posyMaterial);   // define the wall object:  geom + shader
...
negyWall = new THREE.Mesh(wallGeometry3, negyMaterial);   // define the wall object:  geom + shader
...
poszWall = new THREE.Mesh(wallGeometry4, poszMaterial);   // define the wall object:  geom + shader
...
negzWall = new THREE.Mesh(wallGeometry5, negzMaterial);   // define the wall object:  geom + shader
